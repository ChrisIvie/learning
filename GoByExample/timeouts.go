...
// Timeouts are important for programs that connectto external resources or that otherwise need to bounce execution time. 
...
func main() {
	...
	// This is a common pattern to prevent goroutines leaks in case the channel is never read. 
