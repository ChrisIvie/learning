...
// Go supports anonymous functions, which can form closures. Anonymous functions are useful wehn you want to define a function inline without having to name it.
